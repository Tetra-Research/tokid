# profile-compilation Specification

## Purpose
Define the deterministic build-time compilation flow that turns pinned study artifacts and profile recipes into embedded runtime manifests.
